...
```
cd existing_repo
git remote add origin https://git.dktsoft.com:2008/training/preintern2022-07/banner-service.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.dktsoft.com:2008/training/preintern2022-07/banner-service/-/settings/integrations)
